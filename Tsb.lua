...
-- start
createKeyGui()
chỉnh script thêm logo ở góc phải màn hình:code logo(chỉnh sửa cho phù hợp nhé giữ đủ chức năng log thêm lập lánh vô):-- KK Intro: Logo (center) + pulse -> show 2s -> fade out
